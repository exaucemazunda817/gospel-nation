        ...
        {isOneLove && (
          <>
            ...
            <div className="mt-10 rounded-2xl border border-gn-line bg-white p-6 sm:p-7">
              <p className="font-serif text-[15px] italic font-medium text-gn-gold-dark">
            ...
            <div className="mt-8 rounded-2xl border border-gn-line bg-white p-6">
              ...
              <a
                ...
                className="mt-4 inline-flex rounded bg-gn-gold px-5 py-2.5 text-[11.5px] font-bold uppercase tracking-wide text-gn-black transition-opacity hover:opacity-90"
              >
